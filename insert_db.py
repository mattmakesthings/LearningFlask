...
doctors = [Doctor(first_name = "lisa", last_name = "cuddy", specialty = "endocrinology", office_id = "1",rating=4.0),
           ...
           Doctor(first_name = "james", last_name = "wilson", specialty = "oncology", office_id = "2",rating=3.5),
